...
| Archivo | Qué es |
|---------|--------|
| `VenciApp_Terminos_y_Condiciones.md` | Fuente única de los T&C (v2.3). |
| `VenciApp_Politica_Tratamiento_Datos.md` | Fuente única de la política de datos (v2.3). |
| `NOTAS_LEGALES_INTERNAS.md` | Notas de trabajo. **No es público.** Hoy vive en `venciapp/docs/`. |
